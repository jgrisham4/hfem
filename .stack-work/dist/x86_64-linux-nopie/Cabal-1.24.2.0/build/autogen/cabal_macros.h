...
/* package hfem-0.1 */
#define VERSION_hfem "0.1"
#define MIN_VERSION_hfem(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hfem-0.1-GUgq0bRHmyxBtd7xEUSNIC"

#define CURRENT_PACKAGE_KEY "hfem-0.1-GUgq0bRHmyxBtd7xEUSNIC"
