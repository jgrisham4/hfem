...
% What he is suggesting is Galerkin projection of the initial condition onto the basis.
...
% He is being clever in applying the periodic boundary conditions.  he has
% assembled the RHS into a 2x3 matrix which includes the flux, stiffness
% matrix and inverse of the mass matrix.  He named this Stencil.  The
% stencil is 2x3 because the solution at each node is coupled to the
% solution at the other node in the element as well as the right hand side
% node of the upstream element.  This is due to the upwind flux.  
